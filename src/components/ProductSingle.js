      ...
      <div className="row content">
              ...
              <div className="col-md-7 col-lg-7 col-sm-7 products">
                <div className="row">
                  ...
                  <div className="text-center buy-button">
                    <Link to={"/myshop/cart/"} onClick={this.addProductCart.bind(this, pro.id_p)} className="btn btn-info" role="button">{(this.props.cartInfo.indexOf(pro.id_p) === -1) ? 'Купити »': 'Go Cart' }</Link>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="col-md-12 col-lg-12 col-sm-12">
          <div className="related-products">
            <h3 className="page-header">Схожі товари</h3>
