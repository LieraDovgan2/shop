  ...
  render() {
    ...
    return (
      <div className="col-md-12 col-lg-12 col-sm-12 cart">
        <h3 className="page-header">Корзина</h3>
            ...
            <div className="col-md-12 col-lg-12 col-sm-12" key={pro.id_p}>
              <div className="box-product clearfix">
                <div className="col-md-1 col-lg-1 col-sm-1">
                  <Link to={'/myshop/product/'+pro.id_p}><img src={pro.images} className="img-responsive pull-left" alt=""/></Link>
                </div>
        ...
        <div className="cart-button text-center">
          <Link to="/myshop/" className="btn btn-info btn-md">Продовжити покупки</Link>
        </div>
      </div>
    );
  }
